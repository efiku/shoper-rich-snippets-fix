                        ...
                        <div class="f-row">
                            ...
                            <div class=" f-grid-6">
                                <div class="availability row">
                                    ...
                                    ( 1 == $skin_settings->productdetails->shippingcost && $product->canBuyStock() && $enablebasket === true ))
                                    }
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="shipping-costs">
                                            ...
                                            <a href="#deliveries" title="{translate key="check the delivery methods"}" class="showShippingCost">
                                ...
                                <div class="bottomborder row" itemprop="offers" itemscope itemtype="{$schema}://schema.org/Offer">
                                    <link itemprop="url" href="{route full=true function='product' key=$product->product->product_id productName=$product->translation->name productId=$product->product->product_id}">
                                    ...
                                    <div class="basket">
                                            ...
                                            <fieldset class="addtobasket-container{if false == $enablebasket || 0 == (int) $product->defaultStock->availability->availability->can_buy} none{/if}">
                                                ...
                                                <div class="button_wrap">
                                                    <button type="submit" class="addtobasket btn btn-red">
                                                        <img src="{baseDir}/libraries/images/1px.gif" alt="{translate key='Add to cart'}" class="px1">
                                        ...
                                        <p class="center mt-2 r--fs-xl js__product-availability{if !$visibility.additional_text} none{/if}">
                                    ...
                                    <div class="productdetails-more-details clearfix">
                                        ...
                                        <div class="productdetails-more row">
                                            ...
                                            <div class="row evaluation">
                                                ...
                                                <img src="{baseDir}/libraries/images/1px.gif" alt="" class="px1 star{$star|escape|replace:'.':'-'}">
                                                {/foreach}
                                                </span>
                                                <span class="none">
                                                                            {$product->vote->rate}
...
<div class="bundle-fixed-cart">
    <div class="bundle-fixed-cart-container{if false == $product->canBuyStock()} none{/if}">
        ...
        <div class="bundle-cart">
            ...
            <button id="fixed-cart-add" class="btn btn-red">{if $loyalty_exchange}{translate key="Exchange"}{else}{translate key="Add to cart"}{/if}</button>
        </div>
    </div>
</div>
{/if}
